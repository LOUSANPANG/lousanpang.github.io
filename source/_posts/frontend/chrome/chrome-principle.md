...
cover: https://s3.ax1x.com/2021/01/18/syzUIS.jpg # 缩略图
...
![整体架构](https://s3.ax1x.com/2021/01/18/syzyq0.jpg)
...
[![渲染引擎的内核](https://s3.ax1x.com/2021/01/18/s6SpLt.jpg)](https://imgchr.com/i/s6SpLt)

#### 多进程架构
早期的web浏览器是单线程的，发生⻚⾯⾏为不当、浏览器错误、浏览器插件等错误都会引起整个浏览器或当前运 ⾏的选项卡关闭。因此Chrome将chromium应⽤程序放在相互隔离的独⽴的进程，也就是多进程的一个架构。

[![多进程架构](https://s3.ax1x.com/2021/01/18/s6SAJg.jpg)](https://imgchr.com/i/s6SAJg)
...
[![渲染过程](https://s3.ax1x.com/2021/01/18/s6PbCT.png)](https://imgchr.com/i/s6PbCT)
...
[![构建 DOM 树](https://s3.ax1x.com/2021/01/18/s6i956.jpg)](https://imgchr.com/i/s6i956)
...
[![样式计算](https://s3.ax1x.com/2021/01/18/s6imVI.jpg)](https://imgchr.com/i/s6imVI)
...
[![页面布局](https://s3.ax1x.com/2021/01/18/s6iuIP.jpg)](https://imgchr.com/i/s6iuIP)
...
[![生成分层树](https://s3.ax1x.com/2021/01/18/s6iMPf.jpg)](https://imgchr.com/i/s6iMPf)
...
[![栅格化](https://s3.ax1x.com/2021/01/18/s6ilRS.jpg)](https://imgchr.com/i/s6ilRS)
...
[![创建执行上下文](https://s3.ax1x.com/2021/01/18/s6SCeP.jpg)](https://imgchr.com/i/s6SCeP)
...
![](https://ftp.bmp.ovh/imgs/2021/01/6d8c7b7ea996fede.png)

总的结论就是，执行宏任务，然后执行该宏任务产生的微任务，若微任务在执行过程中产生了新的微任务，则继续执行微任务，微任务执行完毕后，再回到宏任务中进行下一轮循环。举个例子：
![](https://ftp.bmp.ovh/imgs/2021/01/ec9335670f02dd91.jpg)
...
![](https://ftp.bmp.ovh/imgs/2021/01/fc743150e740917c.jpg)
...
![](https://ftp.bmp.ovh/imgs/2021/01/c201fed85e70250f.jpg)

#### 算法比较
![](https://ftp.bmp.ovh/imgs/2021/01/260cbee0e9657742.jpg)
